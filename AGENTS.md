...
Mattermost-shaped root store with per-model contracts, and the first
institution/academic-unit SQL stores. Identity/authentication
...
8. PostgreSQL connection management and migration command — complete for
   ...
   architecture, and institution/academic-unit SQL stores;
