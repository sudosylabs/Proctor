...
func NewExamSittingLifecycleJobFactory(now func() time.Time, newID func() model.JobID) ExamSittingLifecycleJobFactory {
	return ExamSittingLifecycleJobFactory{now: now, newID: newID}
}
