...
// Package mail owns server-specific transactional-mail composition and payloads.
//
...
// suppression, and prepares direct or Sitting fan-out outbox records. It also
// reopens and validates frozen deliveries as complete outbound messages. It does
