...
// and read-only Attempt Workspace bootstrap mechanics. It does not own HTTP or
// WebSocket wire contracts, mutable workspace operations, SQL, VFS selection,
// durable Jobs, or infrastructure lifecycle. The parent exam package remains
