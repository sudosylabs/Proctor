...
`POST /api/v1/academic-units`. New Exam creation, Draft text editing, and Draft
Focus Loss policy replacement require the header because their contracts are
idempotent from introduction.
