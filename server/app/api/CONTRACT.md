...
includes Institution, Programme, Programme Level, Academic Period, Class, Affiliation, Academic Unit Member, Class Member enrollment, User profiles, and account enablement without weakening existing contracts.
