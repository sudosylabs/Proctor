...
includes Institution, Programme, Programme Level, Academic Period, Class, Affiliation, Academic Unit Member, Class Member enrollment, and User profiles without weakening existing contracts.
