...
func TestAcademicUnitOpenAPIAgreesWithRuntime(t *testing.T) {
	...
	suite := openAPIAgreementSuite{
		Operations: []openAPIAgreementOperation{
			...
			{Key: "POST /api/v1/academic-units", Auth: AuthPrincipalRequired, RequestBodyRef: "#/components/requestBodies/CreateAcademicUnit", RequestSchema: "CreateAcademicUnitRequest", SuccessStatus: "201", SuccessRef: "#/components/responses/AcademicUnitCreated", SuccessSchema: "AcademicUnitResponse", PublicErrorCodes: principalMutationContractCodes("request.invalid", "administration.unavailable", "academic_unit.invalid", "academic_unit.conflict")},
