...
func TestRoutesHaveExplicitAuthenticationPolicy(t *testing.T) {
	...
	expected := map[string]api.AuthRequirement{
		...
		http.MethodGet + " /api/v1/roles/{role_id:[ybndrfg8ejkmcpqxot1uwisza345h769]{26}}":                    api.AuthPrivileged,
		http.MethodPatch + " /api/v1/roles/{role_id:[ybndrfg8ejkmcpqxot1uwisza345h769]{26}}":                  api.AuthPrivileged,
		http.MethodDelete + " /api/v1/roles/{role_id:[ybndrfg8ejkmcpqxot1uwisza345h769]{26}}":                 api.AuthPrivileged,
		http.MethodGet + " /api/v1/role-bindings":                                                             api.AuthPrivileged,
		http.MethodPost + " /api/v1/role-bindings":                                                            api.AuthPrivileged,
		http.MethodDelete + " /api/v1/role-bindings/{role_binding_id:[ybndrfg8ejkmcpqxot1uwisza345h769]{26}}": api.AuthPrivileged,
	}
