...
func TestAdminSessionListUsesApplicationQueryAndOmitsCredentials(t *testing.T) {
	...
	httpAPI, err := New(Options{
		...
		SessionAdministrations: sessions, Roles: &roleHTTPApplication{}, RoleBindings: &roleBindingHTTPApplication{}, AuditListings: &auditListingHTTPApplication{}, BuildInfo: BuildInfo{Version: "test"},
