...
DROP TABLE IF EXISTS exam_sitting_mail_recipients;
DROP TABLE IF EXISTS exam_sitting_mail_fanouts;
...
DROP TABLE IF EXISTS exam_attempt_correction_acknowledgements;
...
DROP TRIGGER IF EXISTS sessions_fence_active_attempt ON sessions;
DROP FUNCTION IF EXISTS fence_active_attempt_on_session_revocation();
DROP TABLE IF EXISTS browser_activity_events;
DROP TABLE IF EXISTS browser_activity_sources;
...
DROP TABLE IF EXISTS desktop_registrations;
...
DROP TABLE IF EXISTS mail_audience_states;
