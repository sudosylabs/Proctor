...
func TestExamAttemptOpenAPIAgreesWithRuntime(t *testing.T) {
	...
	suite := openAPIAgreementSuite{
		...
		Schemas: []openAPIAgreementSchema{
			...
			{Name: "AcknowledgeExamCorrectionResponse", DTO: reflect.TypeOf(acknowledgeExamCorrectionResponse{}), Required: []string{"revision_id", "current_revision_id", "runtime_capabilities", "acknowledgement_state", "acknowledged_at"}},
