...
func TestExamAttemptOpenAPIAgreesWithRuntime(t *testing.T) {
	...
	suite := openAPIAgreementSuite{
		...
		Schemas: []openAPIAgreementSchema{
			...
			{Name: "CandidateExamPresentationResponse", DTO: reflect.TypeOf(candidateExamPresentationResponse{}), Required: []string{"attempt_id", "exam_sitting_id", "title", "instructions_markdown", "candidate_runtime_capabilities", "browser_policy", "live_corrections", "resources"}, Nullable: []string{"browser_policy", "candidate_runtime_capabilities.terminal.environment_epoch"}, NonNullable: []string{"live_corrections.acknowledged_at"}},
