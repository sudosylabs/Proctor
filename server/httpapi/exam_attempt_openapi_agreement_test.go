...
func TestExamAttemptOpenAPIAgreesWithRuntime(t *testing.T) {
	...
	suite := openAPIAgreementSuite{
		...
		Schemas: []openAPIAgreementSchema{
			...
			{Name: "CandidateExamPresentationResponse", DTO: reflect.TypeOf(candidateExamPresentationResponse{}), Required: []string{"attempt_id", "exam_sitting_id", "title", "instructions_markdown", "capacity", "candidate_runtime_capabilities", "browser_policy", "live_corrections", "resources"}, Nullable: []string{"browser_policy", "candidate_runtime_capabilities.terminal.environment_epoch"}, NonNullable: []string{"live_corrections.acknowledged_at"}},
			{Name: "CandidateBrowserPolicy", DTO: reflect.TypeOf(candidateBrowserPolicyResponse{}), Required: []string{"enabled", "policy_revision_id", "policy_revision_number", "policy_digest", "browser_activity_disclosure"}},
			{Name: "CandidateLiveCorrection", DTO: reflect.TypeOf(candidateLiveCorrectionResponse{}), Required: []string{"revision_id", "revision_number", "effective_at", "summary", "changed_areas", "affected_capabilities", "acknowledgement_required", "acknowledgement_state"}, NonNullable: []string{"acknowledged_at"}},
			...
			{Name: "CandidateAttemptConfiguration", DTO: reflect.TypeOf(candidateAttemptConfigurationResponse{}), Required: []string{"attempt_configuration_revision", "presentation", "approved_commands", "approved_keybindings", "digest"}},
			{Name: "AttemptConfigurationPresentation", DTO: reflect.TypeOf(model.AttemptConfigurationPresentation{}), Required: []string{"color_theme", "prefer_high_contrast", "zoom_percent", "editor_font_size_px", "editor_line_height_px", "reduced_motion", "screen_reader_mode", "announcement_mode", "cursor_style", "cursor_blinking"}},
			{Name: "AttemptConfigurationCandidate", DTO: reflect.TypeOf(model.AttemptConfigurationCandidate{}), Required: []string{"manifest_fingerprint", "registry_fingerprint", "desktop_build", "desktop_target", "user_settings_revision", "presentation", "approved_commands", "approved_keybindings"}},
			...
			{Name: "BrowserActivityListResponse", DTO: reflect.TypeOf(browserActivityListResponse{}), Required: []string{"items"}, Nullable: []string{"items.location", "items.matched_rule_id", "items.block_reason", "items.redirect_from_sequence"}},
			{Name: "BrowserActivityItemResponse", DTO: reflect.TypeOf(browserActivityItemResponse{}), Required: []string{"source_session_id", "generation", "sequence", "kind", "policy_revision_id", "client_occurred_at", "location", "matched_rule_id", "block_reason", "received_at", "redirect_from_sequence"}, Nullable: []string{"location", "matched_rule_id", "block_reason", "redirect_from_sequence"}},
			{Name: "SubmitExamAttemptRequest", DTO: reflect.TypeOf(submitExamAttemptRequest{}), Required: []string{"participation_id", "generation", "expected_current_revision_id", "expected_workspace_cursor", "final_focus_loss_sequence"}, NonNullable: []string{"browser_activity.final_sequence"}},
			...
			{Name: "AcknowledgeExamCorrectionResponse", Nullable: []string{"runtime_capabilities.terminal.environment_epoch"}, DTO: reflect.TypeOf(acknowledgeExamCorrectionResponse{}), Required: []string{"revision_id", "current_revision_id", "runtime_capabilities", "acknowledgement_state", "acknowledged_at"}},
			{Name: "ExamSubmissionReceiptResponse", DTO: reflect.TypeOf(examSubmissionReceiptResponse{}), Required: []string{"browser_activity", "submission_id", "exam_attempt_id", "exam_revision_id", "state", "workspace_cursor", "manifest_digest", "submitted_at"}},
			{Name: "ExamSubmissionManagerResponse", DTO: reflect.TypeOf(examSubmissionManagerResponse{}), Required: []string{"browser_activity", "submission_id", "exam_id", "exam_sitting_id", "exam_attempt_id", "exam_revision_id", "workspace_id", "manifest_schema_version", "workspace_cursor", "manifest_digest", "manifest_entry_count", "manifest_total_file_bytes", "integrity_state", "submitted_at"}, NonNullable: []string{"final_focus_loss_sequence", "unresolved_integrity_count"}},
