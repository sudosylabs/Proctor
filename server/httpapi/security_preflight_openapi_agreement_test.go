...
func TestSecurityPreflightOpenAPIAgreesWithRuntime(t *testing.T) {
	suite := openAPIAgreementSuite{Operations: []openAPIAgreementOperation{
		...
		{Name: "SecurityCoverageResult", DTO: reflect.TypeOf(model.SecurityCoverageResult{}), Required: []string{"processed_control_sequence", "processed_control_digest", "coverage_result", "source_reset_receipts", "security_interaction_allowed", "delivery_watermark_rejections"}, Nullable: []string{"processed_control_digest"}},
