...
var applicationErrorMappings = map[string]applicationErrorMapping{
	...
	"exam.delivery.metadata_capacity":                             {status: http.StatusConflict},
	"exam.security.preflight_required":                            {status: http.StatusConflict},
	"exam.security.preflight_report_changed":                      {status: http.StatusConflict},
	"exam.security.resume_required":                               {status: http.StatusConflict},
	"exam.delivery.upload_expired":                                {status: http.StatusGone},
	"exam.delivery.batch_conflict":                                {status: http.StatusConflict},
	"exam.delivery.replay_window_exceeded":                        {status: http.StatusConflict},
	"exam.delivery.pending_capacity":                              {status: http.StatusTooManyRequests},
	"exam.delivery.append_rate_limited":                           {status: http.StatusTooManyRequests},
	"exam.delivery.detail_budget_exhausted":                       {status: http.StatusConflict},
	"exam.delivery.declaration_conflict":                          {status: http.StatusConflict},
	"exam.delivery.sequence_limit":                                {status: http.StatusConflict},
	"exam.delivery.missing_interval_limit":                        {status: http.StatusConflict},
	"exam.delivery.control_rate_limited":                          {status: http.StatusTooManyRequests},
	"exam.delivery.summary_rate_limited":                          {status: http.StatusTooManyRequests},
	"exam.security.control_conflict":                              {status: http.StatusConflict},
	"exam.security.posture_blocked":                               {status: http.StatusConflict},
	"exam.security.preflight_expired":                             {status: http.StatusConflict},
	"exam.security.preflight_superseded":                          {status: http.StatusConflict},
	"exam.security.preflight_consumed":                            {status: http.StatusConflict},
	"exam.security.policy_changed":                                {status: http.StatusConflict},
	"exam.security.session_changed":                               {status: http.StatusConflict},
	"exam.security.configuration_unsupported":                     {status: http.StatusConflict},
	"exam.security.attempt_not_ready":                             {status: http.StatusConflict},
	"exam.security.catalog_unavailable":                           {status: http.StatusConflict},
	"exam.security.unsupported_capability":                        {status: http.StatusConflict},
	"exam.security.preflight_rate_limited":                        {status: http.StatusTooManyRequests},
