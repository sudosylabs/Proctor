...
var applicationErrorMappings = map[string]applicationErrorMapping{
	"exam.export.not_found":                                       {status: http.StatusNotFound},
	"exam.export.policy_unconfigured":                             {status: http.StatusConflict},
	"exam.export.limit":                                           {status: http.StatusConflict},
	"exam.export.source_retired":                                  {status: http.StatusConflict},
	"exam.export.scope_changed":                                   {status: http.StatusConflict},
	"exam.export.conflict":                                        {status: http.StatusConflict},
	"exam.export.not_ready":                                       {status: http.StatusConflict},
	"exam.export.expired":                                         {status: http.StatusGone},
	"exam.export.unavailable":                                     {status: http.StatusServiceUnavailable},
	"retention.invalid":                                           {status: http.StatusBadRequest},
	"retention.conflict":                                          {status: http.StatusConflict},
	"retention.unavailable":                                       {status: http.StatusServiceUnavailable},
	"authentication.mfa.reset_invalid":                            {status: http.StatusBadRequest},
	"authentication.mfa.reenrollment_required":                    {status: http.StatusForbidden},
	"service.busy":                                                {status: http.StatusServiceUnavailable},
	"authentication.reauthentication_method_required":             {status: http.StatusConflict},
	...
	"authentication.desktop_authorization.invalid":                {status: http.StatusBadRequest},
	"authentication.desktop_authorization.disabled":               {status: http.StatusForbidden},
	"authentication.desktop_authorization.rejected":               {status: http.StatusUnauthorized},
	"authentication.desktop_authorization.unavailable":            {status: http.StatusServiceUnavailable},
	"authentication.desktop_authorization.account_session_locked": {status: http.StatusConflict},
	"authentication.desktop_authorization.incompatible":           {status: http.StatusConflict},
	"authentication.dpop.invalid":                                 {status: http.StatusUnauthorized},
	"authentication.dpop.replayed":                                {status: http.StatusUnauthorized},
	"authentication.dpop.use_nonce":                               {status: http.StatusUnauthorized},
	"authentication.dpop.unavailable":                             {status: http.StatusServiceUnavailable},
	...
	"access_policy.invalid":                                       {status: http.StatusBadRequest},
	"access_policy.revision_conflict":                             {status: http.StatusConflict},
	"access_policy.blocked":                                       {status: http.StatusConflict},
	"access_policy.unavailable":                                   {status: http.StatusServiceUnavailable},
	"retention_policy.invalid":                                    {status: http.StatusBadRequest},
	"retention_policy.revision_conflict":                          {status: http.StatusConflict},
	"retention_policy.unavailable":                                {status: http.StatusServiceUnavailable},
	"desktop_compatibility_policy.invalid":                        {status: http.StatusBadRequest},
	"desktop_compatibility_policy.revision_conflict":              {status: http.StatusConflict},
	"desktop_compatibility_policy.unavailable":                    {status: http.StatusServiceUnavailable},
	"desktop_registration.unavailable":                            {status: http.StatusInternalServerError},
	"user_settings.unavailable":                                   {status: http.StatusInternalServerError},
	"user_settings.invalid":                                       {status: http.StatusBadRequest},
	"user_settings.format_unsupported":                            {status: http.StatusConflict},
	"user_settings.revision_conflict":                             {status: http.StatusConflict},
	...
	"onboarding_import.conflict":                                  {status: http.StatusConflict},
	"onboarding_import.invalid_file":                              {status: http.StatusBadRequest},
	"onboarding_import.unavailable":                               {status: http.StatusServiceUnavailable},
	"student_progression.target_conflict":                         {status: http.StatusConflict},
	"student_progression.lineage_conflict":                        {status: http.StatusConflict},
	"student_progression.effective_date_conflict":                 {status: http.StatusConflict},
	"student_progression.roster_too_large":                        {status: http.StatusConflict},
	"student_progression.conflict":                                {status: http.StatusConflict},
	"student_progression.unavailable":                             {status: http.StatusServiceUnavailable},
	"invitation.role_not_delegable":                               {status: http.StatusConflict},
	"invitation.mail_unavailable":                                 {status: http.StatusServiceUnavailable},
	"invitation.unavailable":                                      {status: http.StatusServiceUnavailable},
	...
	"mail.rekey.conflict":                                         {status: http.StatusConflict},
	"mail.rekey.invalid":                                          {status: http.StatusBadRequest},
	...
	"exam.attempt.registered_desktop_required":                    {status: http.StatusForbidden},
	"exam.attempt.desktop_incompatible":                           {status: http.StatusConflict},
	"exam.attempt.configuration_required":                         {status: http.StatusConflict},
	"exam.attempt.configuration_stale":                            {status: http.StatusConflict},
	"exam.attempt.configuration_frozen":                           {status: http.StatusConflict},
	"exam.attempt.configuration_unsupported":                      {status: http.StatusConflict},
	...
	"exam.attempt.management_authority_conflict":                  {status: http.StatusConflict},
	...
	"exam.attempt.workspace.path_conflict":                        {status: http.StatusConflict},
	"exam.attempt.workspace.cursor_conflict":                      {status: http.StatusConflict},
	"exam.attempt.workspace.entry_conflict":                       {status: http.StatusConflict},
	"exam.attempt.workspace.content_conflict":                     {status: http.StatusConflict},
	"exam.attempt.workspace.directory_not_empty":                  {status: http.StatusConflict},
	"exam.attempt.workspace.entry_limit":                          {status: http.StatusConflict},
	"exam.attempt.workspace.size_limit":                           {status: http.StatusConflict},
	"exam.attempt.workspace.object_conflict":                      {status: http.StatusConflict},
	"exam.attempt.focus_loss_conflict":                            {status: http.StatusConflict},
	"exam.attempt.correction_conflict":                            {status: http.StatusConflict},
	"exam.attempt.browser_activity_conflict":                      {status: http.StatusConflict},
	"exam.attempt.unavailable":                                    {status: http.StatusInternalServerError},
	"exam.integrity_review.invalid":                               {status: http.StatusBadRequest},
	"exam.integrity_review.not_found":                             {status: http.StatusNotFound},
	"exam.integrity_review.revision_conflict":                     {status: http.StatusConflict},
	"exam.integrity_review.state_conflict":                        {status: http.StatusConflict},
	"exam.integrity_review.incomplete":                            {status: http.StatusConflict},
	"exam.integrity_review.too_large":                             {status: http.StatusConflict},
	"exam.integrity_review.unavailable":                           {status: http.StatusInternalServerError},
	...
	"exam.manager.candidate_conflict":                             {status: http.StatusConflict},
	...
	"installation.bootstrap_denied":                               {status: http.StatusForbidden},
	...
	"authentication.registration.invalid":                         {status: http.StatusBadRequest},
	"authentication.registration.invitation_required":             {status: http.StatusForbidden},
	"authentication.registration.unavailable":                     {status: http.StatusServiceUnavailable},
	...
	"authentication.method.disabled":                              {status: http.StatusForbidden},
	"authentication.method.last_usable":                           {status: http.StatusConflict},
	"authentication.method.not_found":                             {status: http.StatusNotFound},
	"authentication.method.provider_conflict":                     {status: http.StatusConflict},
	"authentication.method.conflict":                              {status: http.StatusConflict},
	"authentication.method.unavailable":                           {status: http.StatusServiceUnavailable},
