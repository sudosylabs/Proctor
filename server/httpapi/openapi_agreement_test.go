...
func identityAndSystemErrorContracts() map[string][]string {
	return map[string][]string{
		...
		"POST /api/v1/auth/browser/invitations/accept":                                       {"request.invalid", "authentication.rate_limited", "authentication.rate_limit_unavailable", "invitation.invalid", "invitation.user_invalid", "invitation.mail_unavailable", "invitation.unavailable", "authentication.password.invalid"},
		...
		"POST /api/v1/auth/desktop/authorizations/authenticate/password":                     {"request.invalid", "authentication.desktop_authorization.invalid", "authentication.desktop_authorization.rejected", "authentication.desktop_authorization.unavailable", "authentication.desktop_authorization.account_session_locked", "authentication.invalid_credentials", "authentication.mfa.required", "authentication.mfa.invalid_code", "authentication.mfa.unavailable", "authentication.rate_limited", "authentication.rate_limit_unavailable"},
		...
		"DELETE /api/v1/users/me/desktop-registrations/{desktop_registration_id}":            append(sessionErrorCodes("desktop_registration.unavailable"), "authentication.strong_required", "authentication.reauthentication_required", "request.invalid", "resource.not_found", "audit.unavailable"),
