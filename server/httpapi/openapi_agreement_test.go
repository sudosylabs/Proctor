...
func identityAndSystemOpenAPIAgreementSuite() openAPIAgreementSuite {
	...
	operations := []openAPIAgreementOperation{
		...
		operation("GET /api/v1/system/ping", AuthPublic, "", "", "200", "#/components/responses/SystemPingOK", "SystemPingResponse"),
		operation("GET /api/v1/system/version", AuthPublic, "", "", "200", "#/components/responses/BuildInfoOK", "BuildInfoResponse"),
		operation("POST /api/v1/auth/browser/invitations", AuthPublic, "#/components/requestBodies/BrowserInvitationStart", "BrowserInvitationStartRequest", "201", "#/components/responses/BrowserInvitationStarted", "BrowserInvitationStartResponse"),
		operation("POST /api/v1/auth/browser/invitations/accept", AuthPublic, "#/components/requestBodies/BrowserInvitationAcceptance", "BrowserInvitationAcceptanceRequest", "200", "#/components/responses/BrowserInvitationAccepted", "InvitationAcceptanceResponse"),
		operation("POST /api/v1/auth/browser/invitations/accept-session", AuthSessionRequired, "#/components/requestBodies/BrowserInvitationSessionAcceptance", "BrowserInvitationSessionAcceptanceRequest", "200", "#/components/responses/BrowserInvitationAccepted", "InvitationAcceptanceResponse"),
		...
		operation("POST /api/v1/auth/desktop/authorizations/bind", AuthPublic, "#/components/requestBodies/DesktopAuthorizationProof", "DesktopAuthorizationProofRequest", "204", "#/components/responses/SensitiveNoContent", ""),
		operation("GET /api/v1/auth/desktop/authorizations/context", AuthPublic, "", "", "200", "#/components/responses/DesktopAuthorizationContextOK", "DesktopAuthorizationContextResponse"),
		operation("POST /api/v1/auth/desktop/authorizations/authenticate/session", AuthSessionRequired, "", "", "200", "#/components/responses/DesktopAuthorizationContextOK", "DesktopAuthorizationContextResponse"),
		operation("POST /api/v1/auth/desktop/authorizations/authenticate/password", AuthPublic, "#/components/requestBodies/DesktopAuthorizationLocalAuthentication", "DesktopAuthorizationLocalAuthenticationRequest", "200", "#/components/responses/DesktopAuthorizationContextOK", "DesktopAuthorizationContextResponse"),
		operation("GET /api/v1/auth/desktop/authorizations/authenticate/providers/{provider_id}/login", AuthPublic, "", "", "303", "#/components/responses/ExternalAuthenticationRedirect", ""),
		operation("POST /api/v1/auth/desktop/authorizations/account/reset", AuthPublic, "", "", "204", "#/components/responses/SensitiveNoContent", ""),
		operation("POST /api/v1/auth/desktop/authorizations/approve", AuthPublic, "#/components/requestBodies/DesktopAuthorizationState", "DesktopAuthorizationStateRequest", "200", "#/components/responses/DesktopAuthorizationApproved", "DesktopAuthorizationApprovalResponse"),
		operation("POST /api/v1/auth/desktop/authorizations/cancel", AuthPublic, "#/components/requestBodies/DesktopAuthorizationState", "DesktopAuthorizationStateRequest", "204", "#/components/responses/SensitiveNoContent", ""),
		operation("POST /api/v1/auth/desktop/token", AuthPublic, "#/components/requestBodies/DesktopAuthorizationExchange", "DesktopAuthorizationExchangeRequest", "200", "#/components/responses/DesktopAuthenticationOK", "AuthenticationResponse"),
		...
		operation("GET /api/v1/users/me/desktop-registrations", AuthSessionRequired, "", "", "200", "#/components/responses/DesktopRegistrationListOK", "DesktopRegistrationListResponse"),
	...
	return openAPIAgreementSuite{
		...
		Schemas: []openAPIAgreementSchema{
			...
			{Name: "SystemPingResponse", DTO: reflect.TypeOf(systemPingResponse{}), Required: []string{"schema_version", "server_time", "availability", "reason", "compatibility", "compatibility_reason"}},
			...
			{Name: "BrowserInvitationStartResponse", DTO: reflect.TypeOf(browserInvitationStartResponse{}), Required: []string{"handle", "purpose", "requirement", "expires_at"}},
			{Name: "InvitationAcceptanceResponse", DTO: reflect.TypeOf(invitationAcceptanceResponse{}), Required: []string{"user_id", "invitation_id", "replayed"}},
			{Name: "DesktopAuthorizationStartRequest", DTO: reflect.TypeOf(desktopAuthorizationStartRequest{}), Required: []string{"callback_url", "state", "code_challenge", "public_jwk", "desktop_release", "desktop_build_id", "platform", "architecture", "realtime_protocol"}},
			...
			{Name: "DesktopAuthorizationStateRequest", DTO: reflect.TypeOf(desktopAuthorizationStateRequest{}), Required: []string{"state"}},
			{Name: "DesktopAuthorizationLocalAuthenticationRequest", DTO: reflect.TypeOf(desktopAuthorizationLocalAuthenticationRequest{}), Required: []string{"login_id", "password"}},
			{Name: "DesktopAuthorizationExchangeRequest", DTO: reflect.TypeOf(desktopAuthorizationExchangeRequest{}), Required: []string{"code", "state", "code_verifier", "public_jwk", "desktop_release", "desktop_build_id", "platform", "architecture", "realtime_protocol"}},
			...
			{Name: "DesktopAuthorizationAccountResponse", DTO: reflect.TypeOf(desktopAuthorizationAccountResponse{}), Required: []string{"id", "username", "display_name"}},
			{Name: "DesktopAuthorizationContextResponse", DTO: reflect.TypeOf(desktopAuthorizationContextResponse{}), Required: []string{"state", "local_login_enabled", "external_providers", "device_name", "expires_at"}},
...
func identityAndSystemErrorContracts() map[string][]string {
	return map[string][]string{
		"GET /health/live": {"not_live"}, "GET /health/ready": {"not_ready"},
		"GET /api/v1/system/ping": {"request.invalid"}, "GET /api/v1/system/version": {},
		"POST /api/v1/auth/login":                                                            {"request.invalid", "authentication.client_type.invalid", "authentication.password.invalid", "service.busy", "authentication.invalid_credentials", "authentication.mfa.required", "authentication.mfa.invalid_code", "authentication.mfa.unavailable", "authentication.sessions.maximum_reached", "authentication.desktop_authorization.account_session_locked", "authentication.rate_limited", "authentication.rate_limit_unavailable", "authentication.internal"},
		"POST /api/v1/auth/register":                                                         {"request.invalid", "authentication.password.invalid", "service.busy", "authentication.registration.invalid", "authentication.registration.invitation_required", "authentication.registration.unavailable", "authentication.rate_limited", "authentication.rate_limit_unavailable"},
		"POST /api/v1/auth/browser/invitations":                                              {"request.invalid", "authentication.rate_limited", "authentication.rate_limit_unavailable", "invitation.invalid", "invitation.unavailable"},
		"POST /api/v1/auth/browser/invitations/accept":                                       {"request.invalid", "authentication.rate_limited", "authentication.rate_limit_unavailable", "invitation.invalid", "invitation.user_invalid", "invitation.mail_unavailable", "invitation.unavailable", "authentication.password.invalid", "service.busy"},
		"POST /api/v1/auth/browser/invitations/accept-session":                               sessionMutationErrorCodes("authentication.rate_limited", "authentication.rate_limit_unavailable", "invitation.invalid", "invitation.unavailable"),
		...
		"POST /api/v1/auth/desktop/authorizations/bind":                                      {"request.invalid", "authentication.desktop_authorization.invalid", "authentication.desktop_authorization.rejected", "authentication.desktop_authorization.unavailable", "authentication.desktop_authorization.account_session_locked"},
		"GET /api/v1/auth/desktop/authorizations/context":                                    {"request.invalid", "authentication.desktop_authorization.invalid", "authentication.desktop_authorization.rejected", "authentication.desktop_authorization.unavailable", "authentication.desktop_authorization.account_session_locked"},
		"POST /api/v1/auth/desktop/authorizations/authenticate/session":                      sessionMutationErrorCodes("request.invalid", "authentication.desktop_authorization.invalid", "authentication.desktop_authorization.rejected", "authentication.desktop_authorization.unavailable", "authentication.desktop_authorization.account_session_locked"),
		"POST /api/v1/auth/desktop/authorizations/authenticate/password":                     {"service.busy", "request.invalid", "authentication.desktop_authorization.invalid", "authentication.desktop_authorization.rejected", "authentication.desktop_authorization.unavailable", "authentication.desktop_authorization.account_session_locked", "authentication.invalid_credentials", "authentication.mfa.required", "authentication.mfa.invalid_code", "authentication.mfa.unavailable", "authentication.rate_limited", "authentication.rate_limit_unavailable"},
		"GET /api/v1/auth/desktop/authorizations/authenticate/providers/{provider_id}/login": {"request.invalid", "authentication.desktop_authorization.invalid", "authentication.desktop_authorization.rejected", "authentication.desktop_authorization.unavailable", "authentication.desktop_authorization.account_session_locked", "authentication.external.provider_not_found", "authentication.external.request.invalid", "authentication.external.unavailable", "authentication.rate_limited", "authentication.rate_limit_unavailable"},
		"POST /api/v1/auth/desktop/authorizations/account/reset":                             {"request.invalid", "authentication.desktop_authorization.invalid", "authentication.desktop_authorization.rejected", "authentication.desktop_authorization.unavailable", "authentication.desktop_authorization.account_session_locked"},
		"POST /api/v1/auth/desktop/authorizations/approve":                                   {"request.invalid", "authentication.desktop_authorization.invalid", "authentication.desktop_authorization.rejected", "authentication.desktop_authorization.unavailable", "authentication.desktop_authorization.account_session_locked", "audit.unavailable"},
		"POST /api/v1/auth/desktop/authorizations/cancel":                                    {"request.invalid", "authentication.desktop_authorization.invalid", "authentication.desktop_authorization.rejected", "authentication.desktop_authorization.unavailable", "authentication.desktop_authorization.account_session_locked"},
		...
		"POST /api/v1/auth/password-reset/complete":                                          {"request.invalid", "authentication.password.invalid", "service.busy", "authentication.rate_limited", "authentication.rate_limit_unavailable", "authentication.account_token.invalid", "authentication.account_recovery.unavailable"},
