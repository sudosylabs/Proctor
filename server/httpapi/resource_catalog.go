...
func productionResources(
	...
	return []resource{
		...
		retentionPolicyResource(applications.retentionPolicy),
		retentionResource(applications.retention),
		examRecordsResource(applications.examRecords),
		examExportsResource(applications.examExports),
		...
		sessionReauthenticationResource(applications.sessionReauthentication, cookies),
		mfaResource(applications.mfa),
		mfaAdministrationResource(applications.mfaAdministration),
		...
		securityPreflightResource(applications.examAttempts),
		nativeDeliveryResource(applications.examAttempts),
		browserDeliveryResource(applications.examAttempts),
		deliveryBudgetResource(applications.examAttempts),
