...
func TestV1HTTPContractCharacterization(t *testing.T) {
	...
	const wantDigest = "64ab74fb3ea56f8193d98fa02ed7a2577eb6a76ca4d46da3ae3669be240f8e19"
	...
	if operationCount != 215 {
		t.Fatalf("v1 operation count = %d, want 215", operationCount)
	}
