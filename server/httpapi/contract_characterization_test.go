...
func TestV1HTTPContractCharacterization(t *testing.T) {
	...
	const wantDigest = "9ddb9d1bd93096404071eb02eac63d765a6d295fdcce438abb21c1d4a5fda6ef"
	...
	if operationCount != 280 {
		t.Fatalf("v1 operation count = %d, want 280", operationCount)
	}
